...
class PostEndpointTestCase(APITestCase):
    ...
    def test_get_text_post(self):
        ...
        postUrl = '/authors/' + author1["id"] + \
            '/posts/' + textPostPlain["id"] + '/'
        ...
        self.assertEqual(responseJson["contentType"],
                         textPostPlain["contentType"])
        self.assertEqual(responseJson["content"], textPostPlain["content"])
        self.assertEqual(responseJson["description"],
                         textPostPlain["description"])
        self.assertEqual(responseJson["visibility"],
                         textPostPlain["visibility"])
        ...
        self.assertEqual(responseJson["categories"],
                         textPostPlain["categories"])
        ...
        self.assertEqual(responseJson["author"]
    ...
    def test_get_image_post_jpeg(self):
        ...
        addPostUrl = '/authors/' + \
            author1["id"] + '/posts/' + imagePostJpeg["id"] + '/'
        getPostUrl = '/authors/' + \
            author1["id"] + '/posts/' + imagePostJpeg["id"] + '/image/'
        ...
        self.assertEqual(response.content, open(
            os.getcwd() + "/testing_media/test.jpeg", 'rb').read())
    ...
    def test_get_image_post_png(self):
        ...
        addPostUrl = '/authors/' + \
            author1["id"] + '/posts/' + imagePostPng["id"] + '/'
        getPostUrl = '/authors/' + \
            author1["id"] + '/posts/' + imagePostPng["id"] + '/image/'
        ...
        # Check if the image matches the posted image
        self.assertEqual(response.content, open(
            os.getcwd() + "/testing_media/test.png", 'rb').read())
    ...
    def test_get_image_post_base64(self):
        ...
        addPostUrl = '/authors/' + \
            author1["id"] + '/posts/' + imagePostBase64["id"] + '/'
        getPostUrl = '/authors/' + \
            author1["id"] + '/posts/' + imagePostBase64["id"] + '/image/'
